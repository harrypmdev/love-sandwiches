...
def update_sales_worksheet(data):
    """
    Update sales worksheet with the list data provided.
    """
...
def update_surplus_worksheet(data):
    """
    Update surplus worksheet with the list data provided
    """
...
def calculate_surplus_data(sales_row):
    """
    Compare sales with stock to calculate surplus data.
    """
